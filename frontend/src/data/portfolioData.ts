import { SkripsiData, ClinicalCase, RotationExperience, MediaInfographic, GuestbookEntry } from '../types';
...
export const personalInfo = {
  ...
  gpa: "3.89 / 4.00",
  status: "Menjelang Sidang Skripsi (Periode Genap)",
  targetGraduation: "September 2026",
  email: "della.puspa.ardiati@gmail.com",
...
export const skripsiResearch: SkripsiData = {
  ...
  subTitle: "Studi Sifat Organoleptik, Analisis Proksimat, dan Estimasi Daya Terima Sensori pada Siswi SMA",
...
export const rotationExperiences: RotationExperience[] = [
  {
    id: "rot-01",
    ...
    highlightMetric: "120+ Pasien diskrining & 14 Kasus Kelolaan Mandiri",
  ...
  },
  {
    ...
    highlightMetric: "Audit 6 Titik Kritis HACCP & Siklus Menu 350 Porsi",
  ...
  },
  {
    ...
    highlightMetric: "180 Balita Diskrining & 45 Ibu Terlatih PMBA",
    iconName: "HeartPulse"
  },
  {
    id: "rot-04",
    ...
    highlightMetric: "2 Tahun Masa Bakti Asisten Praktikum",
    iconName: "FlaskConical"
  }
];

export const mediaInfographics: MediaInfographic[] = [
  {
    id: "med-01",
    title: "Panduan Diet DASH: Sahabat Jantung Sehat Tanpa Garam Berlebih",
    category: "Leaflet Pasien",
    targetAudience: "Pasien Hipertensi Rawat Jalan & Keluarga",
    ...
    keyPoints: ["Takaran Natrium < 2000mg/hari", "Sumber Kalium: Pisang, Alpukat, Bayam", "Label Reading: Waspada Natrium Tersembunyi"],
  ...
  },
  {
    ...
    targetAudience: "Ibu Hamil, Ibu Menyusui, dan Kader Posyandu",
    ...
    keyPoints: ["Asupan Fe & Asam Folat Trimester I-III", "Tekstur MP-ASI bertahap 6-24 bulan", "Pantau KMS di Posyandu rutin"],
    thumbnailBg: "from-[#FFF0F3] to-[#FDE2E4]",
    accentColor: "#D48B9D",
  ...
  },
  {
    ...
    targetAudience: "Dewasa Muda & Komunitas Peduli Diabetes",
    ...
    keyPoints: ["Konsep Glycemic Index & Glycemic Load", "Metode Isi Piringku: 1/4 Karbo, 1/4 Protein, 1/2 Sayur Buah", "Jadwal Makan 3J (Jadwal, Jumlah, Jenis)"],
    thumbnailBg: "from-[#F8E9ED] to-[#F3D1DC]",
    accentColor: "#C97A8E",
  ...
  },
  {
    ...
    targetAudience: "Akademisi, Peneliti Pangan, dan UMKM Nutrisi",
    ...
    keyPoints: ["Substitusi 15% Tepung Kelor & 15% Bekatul", "Rasa Renyah Gurih Gurih Alami", "Bebas Gluten / Gluten-Free Snack"],
    thumbnailBg: "from-[#FDF2F4] to-[#FBE0E6]",
    accentColor: "#BA687D",
...
export const initialGuestbook: GuestbookEntry[] = [
  {
    id: "guest-1",
    name: "Dr. rer. med. Nurul Izzati, M.Sc, RD",
    role: "Dosen Pembimbing Skripsi",
    message: "Progres skripsinya sangat matang, Della. Penguasaan analisis proksimat dan metodologi organoleptik sangat rapi. Sukses untuk ujian sidang mendatang!",
    timestamp: "12 Agustus 2026",
    emoji: "🌸"
  },
  {
    id: "guest-2",
    name: "Kak Farhan, S.Gz (Dietisien RS)",
    role: "Preseptor PKL Klinis RS",
    message: "Salah satu mahasiswa magang paling tanggap saat visite pagi di ruang rawat bedah. Catatan ADIME-nya sangat komprehensif. Ditunggu di dunia kerja ya!",
    timestamp: "08 Agustus 2026",
    emoji: "🩺"
  },
  {
    id: "guest-3",
    name: "Tiara Safitri",
    role: "Teman Seperjuangan Gizi '22",
    message: "Bismillah tembus A ya Del pas sidang! Biskuit daun kelornya beneran enak kemarin pas uji panelis, ga kerasa langu sama sekali!",
    timestamp: "04 Agustus 2026",
    emoji: "✨"
  }
];
