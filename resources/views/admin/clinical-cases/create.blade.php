...
@section('title', 'Tambah Kasus — Admin')

@section('admin-content')
    <div class="max-w-4xl">
        <div class="flex items-center justify-between mb-6">
            <h1 class="font-serif text-2xl font-bold">Tambah Kasus Baru</h1>
        ...
        <form method="POST" action="{{ route('admin.clinical-cases.store') }}" class="space-y-8">
            @csrf
